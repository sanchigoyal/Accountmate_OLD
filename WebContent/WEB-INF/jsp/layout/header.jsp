  ...
  <div class="container">
	...
	<div id="navbar" class="navbar-collapse collapse">
		<ul id="leftnav" class="nav navbar-nav">
			...
			<li class="dropdown">
				<a class="dropdown-toggle pointerCursor not-active" data-toggle="dropdown">Inventory<b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a href="">New Stock Item</a></li>
					<li><a href="">Stock Item List</a></li>
					<li><a href="">Stock Item Categories</a></li>
